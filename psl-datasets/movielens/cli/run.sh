...
readonly ADDITIONAL_EVAL_OPTIONS='--infer SGDInference -D sgd.learningrate=1.0 -D sgd.maxiterations=500 --eval org.linqs.psl.evaluation.statistics.ContinuousEvaluator '
